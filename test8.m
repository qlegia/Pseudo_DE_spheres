% In order to use this routine, you have to run "test8_U32" first 
% to get a good solution, then the good solution is saved to "int_goodU32.mat"
% -------------------------------------------------------------------------
...
%colorbar('vert');
shading interp;
[FH,soln] = integral2(X_W,f',27,13,1);
load int_goodU32;
err = abs(soln-u32);
figure;
surf(Sx,Sy,Sz,err);

% In order to use this routine, you have to run "test9_U22" first 
% to get a good solution, then the good solution is saved to "int1_goodU22.mat"
% -------------------------------------------------------------------------
...
fplot = fplot.^(3/4);
shading interp;
[FH,soln] = integral1(md27,f',27,13,1);
load int1_goodU22;
err = abs(soln-u22);
max_err = max(max(err));
figure;
...
max_e = cap_err(51,err,[1/sqrt(2);0;1/sqrt(2)],0.9)

function [FH,soln] = integral1(X_W,f,L,Lsol,with_h)
...
% --------------------------------------------------------------------------
% Quoc Thong Le Gia, University of NSW, Sydney, Australia. 31-Oct-2004.
% --------------------------------------------------------------------------
...
for ell=1:Lsol
     r_index = 1+ell*(ell+1);
     lambda(r_index-ell:r_index+ell) = ones(1,2*ell+1)./(2*ell+1);
end     

...
% using R.Womersley's quadrature rules over 1600 points on the sphere.
%----------------------------------------------------------------------
% Q. T. Le Gia - 3-May-2004 - Texas A & M University, College Station.
% Nov-15-2004, use new_spectral with extremal (maximum determinant) points
%----------------------------------------------------------------------
clear all;
...
colorbar('vert');
shading interp;
[FH,u39] = new_spectral(md39,f',39,22,1);
save goodU39 u39;
